        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Expense Categories Management</h1>
                <p className="text-sm text-gray-500">Manage expense categories and subcategories</p>
              </div>
            </div>
